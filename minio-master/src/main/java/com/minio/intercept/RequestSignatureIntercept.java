...
//        accessKey = new String(decoder.decode(accessKey), StandardCharsets.UTF_8);
//        secretKey = new String(decoder.decode(secretKey), StandardCharsets.UTF_8);
//
//        if (appId == null) {
...
//        boolean secret = BCryptUtil.checkpw(sign.getAppId(), secretKey);
//
//        if (!access || !secret) {
